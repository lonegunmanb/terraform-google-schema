...
const googleGeminiCodeToolsSettingBinding = `{
  "block": {
    "attributes": {
...
func GoogleGeminiCodeToolsSettingBindingSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleGeminiCodeToolsSettingBinding), &result)
	return &result
}
