...
const googleNetworkSecurityInterceptDeploymentGroup = `{
  "block": {
    "attributes": {
...
func GoogleNetworkSecurityInterceptDeploymentGroupSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleNetworkSecurityInterceptDeploymentGroup), &result)
	return &result
}
