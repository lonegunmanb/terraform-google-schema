...
const googleSccV2OrganizationSccBigQueryExport = `{
  "block": {
    "attributes": {
      "big_query_export_id": {
...
func GoogleSccV2OrganizationSccBigQueryExportSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccV2OrganizationSccBigQueryExport), &result)
	return &result
}
