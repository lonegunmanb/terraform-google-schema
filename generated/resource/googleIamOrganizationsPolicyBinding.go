...
const googleIamOrganizationsPolicyBinding = `{
  "block": {
    "attributes": {
      "annotations": {
...
func GoogleIamOrganizationsPolicyBindingSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleIamOrganizationsPolicyBinding), &result)
	return &result
}
