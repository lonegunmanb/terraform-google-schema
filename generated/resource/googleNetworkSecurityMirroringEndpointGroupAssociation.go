...
const googleNetworkSecurityMirroringEndpointGroupAssociation = `{
  "block": {
    "attributes": {
      "create_time": {
        "computed": true,
...
func GoogleNetworkSecurityMirroringEndpointGroupAssociationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleNetworkSecurityMirroringEndpointGroupAssociation), &result)
	return &result
}
