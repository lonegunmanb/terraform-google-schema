...
const googleOsConfigV2PolicyOrchestratorForOrganization = `{
  "block": {
    "attributes": {
      "action": {
...
func GoogleOsConfigV2PolicyOrchestratorForOrganizationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleOsConfigV2PolicyOrchestratorForOrganization), &result)
	return &result
}
