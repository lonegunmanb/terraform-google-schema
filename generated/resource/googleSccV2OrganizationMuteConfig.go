...
const googleSccV2OrganizationMuteConfig = `{
  "block": {
    "attributes": {
      "create_time": {
        "computed": true,
...
func GoogleSccV2OrganizationMuteConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccV2OrganizationMuteConfig), &result)
	return &result
}
