...
const googleBeyondcorpSecurityGatewayApplication = `{
  "block": {
    "attributes": {
      "application_id": {
...
func GoogleBeyondcorpSecurityGatewayApplicationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleBeyondcorpSecurityGatewayApplication), &result)
	return &result
}
