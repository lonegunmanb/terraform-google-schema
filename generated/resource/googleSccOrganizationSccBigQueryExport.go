...
const googleSccOrganizationSccBigQueryExport = `{
  "block": {
    "attributes": {
      "big_query_export_id": {
...
func GoogleSccOrganizationSccBigQueryExportSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccOrganizationSccBigQueryExport), &result)
	return &result
}
