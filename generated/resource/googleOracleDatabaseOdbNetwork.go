...
const googleOracleDatabaseOdbNetwork = `{
  "block": {
    "attributes": {
      "create_time": {
        "computed": true,
...
func GoogleOracleDatabaseOdbNetworkSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleOracleDatabaseOdbNetwork), &result)
	return &result
}
