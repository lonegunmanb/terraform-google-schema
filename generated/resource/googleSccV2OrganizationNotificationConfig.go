...
const googleSccV2OrganizationNotificationConfig = `{
  "block": {
    "attributes": {
      "config_id": {
...
func GoogleSccV2OrganizationNotificationConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccV2OrganizationNotificationConfig), &result)
	return &result
}
