...
const googleSccV2ProjectSccBigQueryExport = `{
  "block": {
    "attributes": {
      "big_query_export_id": {
...
func GoogleSccV2ProjectSccBigQueryExportSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccV2ProjectSccBigQueryExport), &result)
	return &result
}
