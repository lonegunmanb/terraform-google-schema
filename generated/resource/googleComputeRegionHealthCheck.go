...
const googleComputeRegionHealthCheck = `{
  "block": {
    "attributes": {
      "check_interval_sec": {
...
func GoogleComputeRegionHealthCheckSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeRegionHealthCheck), &result)
	return &result
}
