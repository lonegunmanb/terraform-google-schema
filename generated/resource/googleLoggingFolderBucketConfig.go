...
const googleLoggingFolderBucketConfig = `{
  "block": {
    "attributes": {
      "bucket_id": {
...
func GoogleLoggingFolderBucketConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleLoggingFolderBucketConfig), &result)
	return &result
}
