...
const googleRedisClusterUserCreatedConnections = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func GoogleRedisClusterUserCreatedConnectionsSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleRedisClusterUserCreatedConnections), &result)
	return &result
}
