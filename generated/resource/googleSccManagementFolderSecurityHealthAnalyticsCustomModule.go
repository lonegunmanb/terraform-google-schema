...
const googleSccManagementFolderSecurityHealthAnalyticsCustomModule = `{
  "block": {
    "attributes": {
      "ancestor_module": {
        "computed": true,
...
func GoogleSccManagementFolderSecurityHealthAnalyticsCustomModuleSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccManagementFolderSecurityHealthAnalyticsCustomModule), &result)
	return &result
}
