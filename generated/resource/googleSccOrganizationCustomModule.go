...
const googleSccOrganizationCustomModule = `{
  "block": {
    "attributes": {
      "ancestor_module": {
        "computed": true,
...
func GoogleSccOrganizationCustomModuleSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccOrganizationCustomModule), &result)
	return &result
}
