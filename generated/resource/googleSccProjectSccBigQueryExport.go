...
const googleSccProjectSccBigQueryExport = `{
  "block": {
    "attributes": {
      "big_query_export_id": {
...
func GoogleSccProjectSccBigQueryExportSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccProjectSccBigQueryExport), &result)
	return &result
}
