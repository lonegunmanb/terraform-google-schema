...
const googleGeminiReleaseChannelSetting = `{
  "block": {
    "attributes": {
      "create_time": {
        "computed": true,
...
func GoogleGeminiReleaseChannelSettingSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleGeminiReleaseChannelSetting), &result)
	return &result
}
