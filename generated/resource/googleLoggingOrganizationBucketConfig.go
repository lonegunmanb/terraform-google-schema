...
const googleLoggingOrganizationBucketConfig = `{
  "block": {
    "attributes": {
      "bucket_id": {
...
func GoogleLoggingOrganizationBucketConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleLoggingOrganizationBucketConfig), &result)
	return &result
}
