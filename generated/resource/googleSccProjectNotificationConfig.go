...
const googleSccProjectNotificationConfig = `{
  "block": {
    "attributes": {
      "config_id": {
...
func GoogleSccProjectNotificationConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccProjectNotificationConfig), &result)
	return &result
}
