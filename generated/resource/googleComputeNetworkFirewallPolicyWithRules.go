...
const googleComputeNetworkFirewallPolicyWithRules = `{
  "block": {
    "attributes": {
      "creation_timestamp": {
        "computed": true,
...
func GoogleComputeNetworkFirewallPolicyWithRulesSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeNetworkFirewallPolicyWithRules), &result)
	return &result
}
