...
const googleSccV2FolderNotificationConfig = `{
  "block": {
    "attributes": {
      "config_id": {
...
func GoogleSccV2FolderNotificationConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccV2FolderNotificationConfig), &result)
	return &result
}
