...
const googleOsConfigV2PolicyOrchestratorForFolder = `{
  "block": {
    "attributes": {
      "action": {
...
func GoogleOsConfigV2PolicyOrchestratorForFolderSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleOsConfigV2PolicyOrchestratorForFolder), &result)
	return &result
}
