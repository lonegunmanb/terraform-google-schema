...
const googleNetworkSecurityMirroringDeployment = `{
  "block": {
    "attributes": {
      "create_time": {
        "computed": true,
...
func GoogleNetworkSecurityMirroringDeploymentSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleNetworkSecurityMirroringDeployment), &result)
	return &result
}
