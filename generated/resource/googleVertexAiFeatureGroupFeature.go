...
const googleVertexAiFeatureGroupFeature = `{
  "block": {
    "attributes": {
      "create_time": {
        "computed": true,
...
func GoogleVertexAiFeatureGroupFeatureSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleVertexAiFeatureGroupFeature), &result)
	return &result
}
