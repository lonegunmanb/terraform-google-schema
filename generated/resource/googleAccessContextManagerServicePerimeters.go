...
const googleAccessContextManagerServicePerimeters = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func GoogleAccessContextManagerServicePerimetersSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleAccessContextManagerServicePerimeters), &result)
	return &result
}
