...
const googleComputeRegionSecurityPolicyRule = `{
  "block": {
    "attributes": {
      "action": {
...
func GoogleComputeRegionSecurityPolicyRuleSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeRegionSecurityPolicyRule), &result)
	return &result
}
