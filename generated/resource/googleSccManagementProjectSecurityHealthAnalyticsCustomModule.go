...
const googleSccManagementProjectSecurityHealthAnalyticsCustomModule = `{
  "block": {
    "attributes": {
      "ancestor_module": {
        "computed": true,
...
func GoogleSccManagementProjectSecurityHealthAnalyticsCustomModuleSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccManagementProjectSecurityHealthAnalyticsCustomModule), &result)
	return &result
}
