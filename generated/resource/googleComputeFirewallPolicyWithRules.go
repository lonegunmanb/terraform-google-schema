...
const googleComputeFirewallPolicyWithRules = `{
  "block": {
    "attributes": {
      "creation_timestamp": {
        "computed": true,
...
func GoogleComputeFirewallPolicyWithRulesSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeFirewallPolicyWithRules), &result)
	return &result
}
