...
const googleNetworkSecurityInterceptEndpointGroup = `{
  "block": {
    "attributes": {
      "associations": {
        "computed": true,
...
func GoogleNetworkSecurityInterceptEndpointGroupSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleNetworkSecurityInterceptEndpointGroup), &result)
	return &result
}
