...
const googleComputePerInstanceConfig = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func GoogleComputePerInstanceConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputePerInstanceConfig), &result)
	return &result
}
