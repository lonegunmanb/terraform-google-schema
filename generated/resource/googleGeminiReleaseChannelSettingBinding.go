...
const googleGeminiReleaseChannelSettingBinding = `{
  "block": {
    "attributes": {
      "create_time": {
        "computed": true,
...
func GoogleGeminiReleaseChannelSettingBindingSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleGeminiReleaseChannelSettingBinding), &result)
	return &result
}
