...
const googleSccV2OrganizationSccBigQueryExports = `{
  "block": {
    "attributes": {
      "big_query_export_id": {
...
func GoogleSccV2OrganizationSccBigQueryExportsSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccV2OrganizationSccBigQueryExports), &result)
	return &result
}
