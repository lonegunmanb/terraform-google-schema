...
const googleSccV2ProjectNotificationConfig = `{
  "block": {
    "attributes": {
      "config_id": {
...
func GoogleSccV2ProjectNotificationConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccV2ProjectNotificationConfig), &result)
	return &result
}
