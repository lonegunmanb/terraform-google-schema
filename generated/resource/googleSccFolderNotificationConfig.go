...
const googleSccFolderNotificationConfig = `{
  "block": {
    "attributes": {
      "config_id": {
...
func GoogleSccFolderNotificationConfigSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleSccFolderNotificationConfig), &result)
	return &result
}
