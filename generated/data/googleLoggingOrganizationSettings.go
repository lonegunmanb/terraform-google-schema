...
const googleLoggingOrganizationSettings = `{
  "block": {
    "attributes": {
...
func GoogleLoggingOrganizationSettingsSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleLoggingOrganizationSettings), &result)
	return &result
}
