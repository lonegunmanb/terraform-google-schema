...
const googleComputeRegionSslCertificate = `{
  "block": {
    "attributes": {
      "certificate": {
        "computed": true,
...
func GoogleComputeRegionSslCertificateSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(googleComputeRegionSslCertificate), &result)
	return &result
}
